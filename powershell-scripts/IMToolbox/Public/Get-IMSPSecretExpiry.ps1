...
.DESCRIPTION
    https://github.com/equinor/ideation-machine-infra/wiki/Service-Principal-secret-expiry-script

.EXAMPLE
    SecretExpiry.ps1
#>

function Get-IMSPSecretExpiry {

    # Define how to filter Service Principals and set amount of days ahead you want a notification
    $servicePrincipalFilter = 'ideation-machine'
    $amountOfDays = 14
    ...
    $ignoreList = @('ideation-machine-aurora') #Ignoring Service Principals that is not managed by ideation machine team
    $projectName = 'Ideation Machine - DevOps'
    $label = 'secret-expiry'
    $counter = 0
